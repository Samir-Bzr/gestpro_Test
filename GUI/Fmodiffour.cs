...
namespace gestpro
{
...

    {
        ...
        public SqlConnection con = new SqlConnection(//connection here +
 //connection here );
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string a = @"DELETE FROM FOURNISSEUR WHERE ID_FRS = '" + dataGridView1.CurrentRow.Cells["ID_FRS"].Value.ToString() + "'  ";
